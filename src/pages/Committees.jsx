...
import { 
  ...
  FileText, CheckCircle2, ChevronRight, AlertCircle, ArrowLeft
} from 'lucide-react';
...
const committeesList = [
  {
    ...
    pdf: "/data/Committees/1. Anti-Ragging.pdf",
  ...
  {
    id: "iiic",
    title: "IIIC Cell (Industry-Institute)",
    category: "student-cells",
    categoryLabel: "Student Cells & Associations",
    icon: Building2,
    color: "from-blue-500 to-indigo-600",
    bgColor: "bg-blue-50 border-blue-100 text-blue-700",
    pdf: "/data/Committees/2. Industry Instituion interaction Cell.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/3. Women Empowerment Cell.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/4. Alumni Cell.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/5. SC-ST Commitee.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/6. Electoral Literacy Club.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/7.Career Guidance Cell.pdf",
  ...
  },
  {
    ...
    pdf: "/data/Committees/8. Entrepreneurship Development Cell.pdf",
                    ...
                    >
                      ...
                      <div className="bg-white border border-gray-200 rounded-3xl p-4 md:p-6 shadow-sm flex flex-col space-y-4">
                        ...
                        <div className="w-full bg-slate-100 rounded-2xl overflow-hidden border border-gray-250 relative min-h-[600px] flex items-center justify-center">
                          ...
                          {/* Fallback info layer (underneath or if PDF doesn't load) */}
                          <div className="text-center p-6 space-y-3 pointer-events-none select-none max-w-sm absolute z-0">
                            <AlertCircle className="w-8 h-8 text-gray-400 mx-auto" />
                            <h4 className="text-sm font-black text-gray-700">Loading Document Preview</h4>
                            <p className="text-xs text-gray-500 font-bold">
                              If the preview does not display, you can download the document using the button in the header.
                            </p>
                          </div>
                        </div>
