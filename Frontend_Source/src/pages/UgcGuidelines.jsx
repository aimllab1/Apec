      ...
      <div className="max-w-5xl mx-auto relative z-10 text-left">
        ...
        <div className="mb-6 border-b border-gray-200 pb-6 w-full text-left">
          <div className="flex items-center justify-between gap-3 mb-4 w-full">
            <span className="text-[10px] sm:text-xs font-black tracking-widest text-indigo-650 bg-indigo-50 border border-indigo-100 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full inline-flex items-center gap-2 uppercase">
            ...
            <a 
              ...
              title="Download UGC Guidelines PDF"
              className="flex items-center justify-center gap-2 bg-indigo-650 hover:bg-indigo-700 text-white font-extrabold text-xs uppercase tracking-wider p-2.5 sm:px-5 sm:py-3 rounded-xl shadow-md hover:shadow-indigo-500/10 active:scale-95 transition-all shrink-0 border border-indigo-700"
            >
              <Download className="w-4 h-4" />
              <span className="hidden sm:inline">Download UGC Guidelines PDF</span>
            </a>
          </div>
