...
import { 
  ...
  Lock, ArrowLeft, Printer, CheckCircle2, AlertTriangle, RefreshCw
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-gray-900 py-12 md:py-20 px-4 sm:px-6 md:px-12 relative overflow-hidden">
      ...
      <style dangerouslySetInnerHTML={{__html: `
        @media print {
          ...
          #printable-result-sheet, #printable-result-sheet * {
            visibility: visible;
          }
          ...
          <div>
            ...
            >
              {[
                ...
                { title: "Exam Schedule", desc: "Download final semester timetable and assessment routines.", icon: Calendar },
                ...
                return (
                  <motion.div 
                    ...
                    className={`bg-white border border-gray-250 p-6 rounded-3xl shadow-sm hover:shadow-md transition-all group flex flex-col justify-between text-left ${card.click ? 'cursor-pointer border-indigo-200' : ''}`}
                  >
                    <div>
                      <div className="w-10 h-10 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-650 mb-5 group-hover:scale-110 transition-transform">
                    ...
                    {card.click && (
                      <span className="text-[10px] font-black uppercase text-indigo-650 mt-5 flex items-center gap-1">
                        Access Portal →
                      </span>
                    )}
                  </motion.div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16 pt-8 border-t border-gray-200">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-white border border-gray-250 p-6 rounded-3xl text-center py-12 flex flex-col items-center">
                  <div className="w-12 h-12 rounded-2xl bg-slate-50 border border-gray-250 flex items-center justify-center text-gray-400 mb-4">
            ...
            {/* About COE */}
            <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row gap-8 items-start md:items-center text-left">
              <div className="w-12 h-12 rounded-2xl bg-indigo-50 border border-indigo-100 flex items-center justify-center shrink-0 text-indigo-650">
        ...
        {viewMode === 'search' && (
          <div className="max-w-md mx-auto">
            <button 
              ...
              className="inline-flex items-center gap-2 text-xs font-bold text-gray-600 hover:text-indigo-650 transition-colors mb-6 cursor-pointer"
            >
            ...
            <div className="bg-white border border-gray-200 p-6 sm:p-8 rounded-3xl shadow-lg relative overflow-hidden">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-xl sm:text-2xl font-black text-gray-900 font-title">Student Result Portal</h2>
                <p className="text-xs text-gray-400 font-bold block mt-1 uppercase tracking-wider">Semester Examinations</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      placeholder="Enter Reg No (e.g., 4204)"
              ...
              <div className="mt-6 p-4 bg-slate-50 border border-slate-150 rounded-2xl text-xs font-semibold text-slate-500 text-left">
                <span className="text-[10px] font-black uppercase text-indigo-650 block mb-1">Demo Credentials</span>
                <p className="leading-relaxed">
                  Enter Reg No: <span className="font-mono font-bold text-slate-855 bg-white border px-1.5 py-0.5 rounded">4204</span> and Password: <span className="font-mono font-bold text-slate-855 bg-white border px-1.5 py-0.5 rounded">1234</span> to view results.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 print-hide">
              <button 
                ...
                className="inline-flex items-center gap-2 text-xs font-bold text-gray-600 hover:text-indigo-650 transition-colors cursor-pointer"
              >
              ...
              >
                <Printer className="w-4 h-4" /> Download / Print Result
              </button>
            </div>

            {/* Results Sheet Container */}
            <div 
            ...
            >
              {/* College Heading Header (Visible during prints or on screen) */}
              <div className="flex flex-col sm:flex-row justify-between items-center border-b border-gray-200 pb-6 mb-8 gap-4 text-center sm:text-left">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <h2 className="font-title text-base sm:text-lg font-black text-gray-950 block leading-tight drop-shadow-sm uppercase">
                      Adhiparasakthi Engineering College
                    </h2>
                    <span className="font-mono text-[9px] uppercase font-black text-indigo-650 tracking-wider block mt-0.5">
              ...
              {studentResultProfile.semesters[selectedSemester] ? (
                ...
                <div className="p-8 border border-dashed border-gray-200 rounded-3xl text-center text-gray-400 font-semibold">
              ...
              <div className="flex justify-between items-end mt-12 pt-8 border-t border-gray-150 text-xs text-gray-405 font-semibold">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] uppercase font-black tracking-wider text-gray-400 mt-0.5">APEC (Autonomous)</p>
                </div>
              </div>
